    ...
    public interface StatsRepository extends JpaRepository<EndpointHit, Long> {
        ...
        @Query("SELECT NEW ru.practicum.ewm.stats.model.ViewStats(h.app, h.uri, COUNT(h.ip)) " +
                "FROM EndpointHit h " +
        ...
        @Query("SELECT NEW ru.practicum.ewm.stats.model.ViewStats(h.app, h.uri, COUNT(DISTINCT h.ip)) " +
                "FROM EndpointHit h " +
                "WHERE h.timestamp BETWEEN :start AND :end " +
                "GROUP BY h.app, h.uri " +
